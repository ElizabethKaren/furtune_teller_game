  ...
  loadSign = sign => {
    ...
    switch(sign){
      ...
      case 'Sagittarius':
        ...
        pic = 'https://astrostyle.com/wp-content/uploads/2019/11/SagittariusWeb.jpg'
        break;
      case 'Capricorn':
